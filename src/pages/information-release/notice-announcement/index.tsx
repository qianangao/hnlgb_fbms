...
const NoticeAnnouncement = ({ dispatch, tableRef }) => {
  ...
  const orgChangeHander = orgId => {
    dispatch({
      type: 'noticeAnnouncement/selectOrgChange',
      payload: orgId,
    });
  };
...
export default connect(({ noticeAnnouncement }) => ({
  noticeAnnouncement,
  tableRef: noticeAnnouncement.tableRef,
}))(NoticeAnnouncement);
