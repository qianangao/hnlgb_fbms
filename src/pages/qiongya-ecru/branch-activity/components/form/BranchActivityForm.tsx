...
const BranchActivityForm = ({ form, id, dispatch, loading, partyData }) => {
  ...
  const formItems = [
    ...
    },
    {
      label: '主持人',
      name: 'host',
      rules: [{ required: false, message: '请输入支持人!', whitespace: true }],
    },
    {
      label: '活动日期',
      name: 'activityDate',
      type: 'date',
      rules: [{ required: false, message: '请选择活动日期!', whitespace: true }],
    },
    {
      label: '活动地点',
      name: 'activityAdd',
    ...
    //   label: '接收方式',
    //   name: 'isUser',
    //   rules: [{ required: false, message: '请选择接收方式!' }],
    //   render: (
    //     <Radio.Group>
    ...
    //   label: '接收支部',
    //   name: 'partyIds',
    //   rules: [{ required: false, message: '请选择接收支部!' }],
    //   render: (
    ...
    //   label: '接收人员',
    //   name: 'userIds',
    //   rules: [{ required: false, message: '请选择接收人员!' }],
    ...
    },
    {
      ...
      name: 'context',
      type: 'editor',
      rules: [{ required: false, message: '请输入活动详情!', whitespace: true }],
      span: 2,
    },
  ];
