...
const Table = ({ openAddModal, openModifyModal, policyStipulate, dispatch, opendetailModal }) => {
  const { tableRef, publishStatus } = policyStipulate;
  const columns = [
    {
      title: '序号',
      dataIndex: 'index',
  ...
  const deleteReturnworkPerson = ids => {
    dispatch({
      type: 'policyStipulate/deletePolicyStipulate',
      payload: {
        ids,
      },
    });
...
export default connect(({ policyStipulate, global }) => ({
  policyStipulate,
  enums: global.enums,
}))(Table);
